...
//  FILE:         owlusingvclaboutdlg.cpp
//  AUTHOR:       Greg Bullock
//
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TOWLusingVCLAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TOWLusingVCLAboutDlg Implementation}}
...
//
TOWLusingVCLAboutDlg::TOWLusingVCLAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TOWLusingVCLAboutDlg::~TOWLusingVCLAboutDlg()
{
  Destroy();
...
void TOWLusingVCLAboutDlg::SetupWindow()
{
