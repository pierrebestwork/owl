...
//   Tutorial application -- cntrl16.cpp
//----------------------------------------------------------------------------
#include <owl/pch.h>
...
private:
  void TestAutomation(); //Routine to execute step16
...
TMyApp::InitMainWindow()
{
  ...
  SetMainWindow(new TFrameWindow(0,"Step 16 Controller",Disp));
}
...
TMyApp::TestAutomation()
{
  ...
  try {
    ...
    app.Bind("DrawPad.Application.16");
    ...
    ::MessageBox(0, "End of Program", "CNTRL16.EXE", MB_OK);
