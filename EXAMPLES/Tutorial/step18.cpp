...
//   Tutorial application -- step18.cpp
...
BEGIN_REGISTRATION(AppReg)
  REGDATA(clsid,      "{5E4BD365-8ABC-101B-A23B-CE4E85D07ED2}")
  REGDATA(progid,     "DrawPad.Application.18")
  REGDATA(description,"DrawPad AutoContServer Application")
  REGDATA(appname,    "DrawPad AutoContServer")
//  REGDATA(debugger,   "tdw")   // don't try this in 32-bit
