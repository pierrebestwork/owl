...
#pragma message This file may be older than the one provided with you compiler!
#endif
...
//<Jogy
#define ListView_SetCheckState(hwndLV, i, f)\
    ListView_SetItemState(hwndLV,i,INDEXTOSTATEIMAGEMASK((f) ? 2 : 1),LVIS_STATEIMAGEMASK);
//Jogy>
