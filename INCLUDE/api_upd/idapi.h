...
typedef DBIResult  *pDBIResult;    // Function result pointer
...
typedef hDBIObj    *phDBIObj;      // pointer to generic object handle
typedef hDBIDb     *phDBIDb;       // pointer to Database  handle
typedef hDBIQry    *phDBIQry;      // pointer to Query     handle
typedef hDBIStmt   *phDBIStmt;     // pointer to Statement handle
typedef hDBICur    *phDBICur;      // pointer to Cursor    handle
typedef hDBISes    *phDBISes;      // pointer to Session   handle
typedef hDBIXlt    *phDBIXlt;      // pointer to Translation handle

typedef UINT32          hDBIXact;      // Transaction handle
typedef hDBIXact   *phDBIXact;     // pointer to Transaction handle

typedef hDBIObj         hDBIDR ;       // Handle to a Client Data Repository (CDR) Object
typedef hDBIDR      *phDBIDR ;     // Ptr to CDR Handle
...
typedef CMPBkMkRslt *pCMPBkMkRslt;
...
} DBIQryProgress, *pDBIQryProgress;
...
// Categories
extern const char SZCFGSYSTEM[];
extern const char SZCFGDRIVER[];
extern const char SZCFGDATABASE[];
extern const char SZCFGREPOSITORY[];

// System Fields
extern const char SZCFGSYSVERSION[];
extern const char SZCFGSYSNETTYPE[];
extern const char SZCFGSYSNETDIR[];
extern const char SZCFGSYSLOCALSHARE[];
extern const char SZCFGSYSLANGDRV[];
extern const char SZCFGSYSLANGDRVDIR[];
extern const char SZCFGSYSMINBUF[];
extern const char SZCFGSYSMAXBUF[];
extern const char SZCFGSYSLOCKRETRY[];
extern const char SZCFGSYSFLAGS[];
extern const char SZCFGMAXFILEHANDLES[];
extern const char SZCFGSQLQRYMODE[];
extern const char SZCFGLOWMEMLIMIT[];
extern const char SZCFGSYSODBCCFGIMPORT[];
extern const char SZCFGSYSLOCALREPOSITORY[];
//extern const char SZCFGSYSCOMMONREPOSITORY[];
extern const char SZCFGSYSSHAREDMEMSIZE[];
extern const char SZCFGSYSSHAREDMEMLOCATION[];



// Driver Fields
extern const char SZCFGDRVVERSION[];
extern const char SZCFGDRVTYPE[];
extern const char SZCFGDRVDLL[];
extern const char SZCFGDRVDLL32[];
extern const char SZCFGDRVFLAGS[];
extern const char SZCFGDRVLANGDRIVER[];
extern const char SZCFGDRVFILLFACTOR[];
extern const char SZCFGDRVBLOCKSIZE[];
extern const char SZCFGDRVLOCKPROTOCOL[];
extern const char SZCFGDRVLEVEL[];
extern const char SZCFGDRVTRACEMODE[];

// Dbase Driver fields
extern const char SZCFGDRVMEMOBLOCKSIZE[];
extern const char SZCFGDRVMDXBLOCKSIZE[];



// Driver Nodes
extern const char SZCFGDRVINIT[];
extern const char SZCFGDBCREATE[];
extern const char SZCFGDBOPEN[];
extern const char SZCFGTBLCREATE[];
extern const char SZCFGTBLOPEN[];

// Database Nodes
extern const char SZCFGDBINFO[];

// Database fields
extern const char SZCFGDBTYPE[];
extern const char SZCFGDBPATH[];
extern const char SZCFGDBDEFAULTDRIVER[];
extern const char SZCFGDBENABLEBCD[];

// Others
extern const char SZCFGINIT[];
extern const char SZTYPE[];
extern const char SZCFGDBSTANDARD[];
extern const char SZCFGTRUE[];
extern const char SZCFGFALSE[];
extern const char SZOPENMODE[];
extern const char SZREADWRITE[];
extern const char SZREADONLY[];
extern const char SZSHAREMODE[];
extern const char SZEXCLUSIVE[];
extern const char SZSHARED[];
extern const char SZUSERNAME[];
extern const char SZSERVERNAME[];
extern const char SZDATABASENAME[];
extern const char SZSCHEMASIZE[];
extern const char SZCFGSTRICTINTEGRITY[];
extern const char SZTDSPACKETSIZE[];

// Repository fields
extern const char SZCFGDRDBNAME[];
extern const char SZCFGDRTBLNAME[];
extern const char SZCFGDRDESC[];
extern const char SZCFGDRLANGDRIVER[];


// SYSTEM DATE/TIME/NUMBER FORMATS
// SYSTEM nodes:
extern const char  SZCFGFORMAT[];

// Format nodes:
extern const char  SZCFGDATE[];
extern const char  SZCFGTIME[];
extern const char  SZCFGNUMBER[];

// DATE and/or TIME fields:
extern const char SZCFGSEPARATOR[];
extern const char SZCFGMODE[];
extern const char SZCFGFOURDIGITYEAR[];
extern const char SZCFGYEARBIASED[];
extern const char SZCFGLEADINGZEROM[];
extern const char SZCFGLEADINGZEROD[];
extern const char SZCFGTWELVEHOUR[];
extern const char SZCFGAMSTRING[];
extern const char SZCFGPMSTRING[];
extern const char SZCFGSECONDS[];
extern const char SZCFGMILSECONDS[];

// Number fields:
extern const char SZCFGDECIMALSEPARATOR[];
extern const char SZCFGTHOUSANDSEPARATOR[];
extern const char SZCFGDECIMALDIGITS[];
extern const char SZCFGLEADINGZERON[];


extern const char SZCFGDEFLANGDRV[];
extern const char SZCFGDBASEDEFLANGDRV[];
extern const char SZCFGDEFSEPARATOR[];
extern const char SZCFGDEFMODE[];
extern const char SZCFGDEFFOURDIGITYEAR[];
extern const char SZCFGDEFYEARBIASED[];
extern const char SZCFGDEFLEADINGZEROM[];
extern const char SZCFGDEFLEADINGZEROD[];
extern const char SZCFGDEFTWELVEHOUR[];
extern const char SZCFGDEFAMSTRING[];
extern const char SZCFGDEFPMSTRING[];
extern const char SZCFGDEFSECONDS[];
extern const char SZCFGDEFMILSECONDS[];
extern const char SZCFGDEFDECIMALSEPARATOR[];
extern const char SZCFGDEFTHOUSANDSEPARATOR[];
extern const char SZCFGDEFLEADINGZERO[];
