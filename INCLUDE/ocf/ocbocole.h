...
#  else
#		define DEFINE_BOLEGUID(name, l) EXTERN_C __import const GUID CDECL FAR name
#  endif
...
class _ICLASS IBDataNegotiator : public IUnknown {
  public:
    ...
    virtual HRESULT  _IFUNC GetFormat(uint, TOcFormatInfo *) = 0;
};
...
class _ICLASS IBDataProvider : public IBDataNegotiator {
  public:
    ...
    virtual HRESULT _IFUNC Draw(HDC, const RECTL *,
                                ...
                                TOcDraw bd = drNone)               = 0;
    virtual HRESULT _IFUNC GetPartSize(__OWL TSize *)                 = 0;
...
class _ICLASS IBPart : public IBDataProvider {
  public:
    ...
    virtual HRESULT _IFUNC SetPartSize(__OWL TSize *)                 = 0;
    virtual HRESULT _IFUNC SetPartPos(__OWL TRect *)                  = 0;
    ...
    virtual void    _IFUNC FrameResized(const __OWL TRect *, BOOL)    = 0;
    virtual HRESULT _IFUNC DragFeedback(__OWL TPoint *, BOOL)         = 0;
...
class _ICLASS IBWindow : public IUnknown {
  public:
    ...
    virtual HRESULT  _IFUNC GetWindowRect(__OWL TRect *)                 = 0;
    ...
    virtual HRESULT  _IFUNC RequestBorderSpace(const __OWL TRect *)      = 0;
    virtual HRESULT  _IFUNC SetBorderSpace(const __OWL TRect *)          = 0;
...
class _ICLASS IBContainer : public IBWindow {
  public:
    virtual HRESULT  _IFUNC FindDropDest(__OWL TPoint *, IBDropDest * *)=0;
...
class _ICLASS IBDropDest : public IBDataConsumer {
  public:
    virtual HRESULT  _IFUNC Drop(TOcInitInfo *, __OWL TPoint *,
                                 const __OWL TRect *)                    = 0;
    virtual void     _IFUNC DragFeedback(__OWL TPoint *, const __OWL TRect *,
                                         TOcMouseAction, uint, HRESULT&) = 0;
    virtual HRESULT  _IFUNC Scroll(TOcScrollDir scrollDir)            = 0;
    virtual HRESULT  _IFUNC GetScrollRect(__OWL TRect *)                 = 0;
};
...
class _ICLASS IBSite : public IUnknown {
  public:
    ...
    virtual HRESULT _IFUNC GetSiteRect(__OWL TRect *, __OWL TRect *)        = 0;
    virtual HRESULT _IFUNC SetSiteRect(const __OWL TRect *)              = 0;
    virtual HRESULT _IFUNC SetSiteExtent(const __OWL TSize *)            = 0;
...
class _ICLASS IBControlSite : public IUnknown
{
  public:
    ...
    virtual HRESULT _IFUNC TransformCoords(__OWL TPointL * lpptlHimetric,
                            __OWL TPointF * lpptfContainer, DWORD flags)  = 0;
};
