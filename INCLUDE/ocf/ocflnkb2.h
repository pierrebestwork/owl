...
//$Revision: 1.4.2.1 $
//$Author: jogybl $
//$Date: 2009-09-01 10:33:54 $
//
//
//----------------------------------------------------------------------------

#if !defined(OCF_OCFLNKB2_H)
#define OCF_OCFLNKB2_H
...
#       pragma comment(lib, "ocf-630-b2-dvc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug VCL multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "ocf-630-b2-dvc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)
	      // Debug VCL multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "ocf-630-b2-dvc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug VCL multi-threaded static library 
#       pragma comment(lib, "ocf-630-b2-dv.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
#    endif	                    // #if defined(_OCFDLL)	
...
#       pragma comment(lib, "ocf-630-b2-dtc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "ocf-630-b2-dtc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "ocf-630-b2-dtc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded import library 
#       pragma comment(lib, "ocf-630-b2-dti.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "ocf-630-b2-dtc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "ocf-630-b2-dtc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "ocf-630-b2-dtc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded static library 
#       pragma comment(lib, "ocf-630-b2-dt.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "ocf-630-b2-dsc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded OWL2 compatibility import library 
#       pragma comment(lib, "ocf-630-b2-dsc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded OWL5 compatibility import library 
#       pragma comment(lib, "ocf-630-b2-dsc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded import library 
#       pragma comment(lib, "ocf-630-b2-dsi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "ocf-630-b2-dsc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded OWL2 compatibility static library 
#       pragma comment(lib, "ocf-630-b2-dsc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded OWL5 compatibility static library 
#       pragma comment(lib, "ocf-630-b2-dsc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded static library 
#       pragma comment(lib, "ocf-630-b2-ds.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "ocf-630-b2-tc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "ocf-630-b2-tc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "ocf-630-b2-tc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release multi-threaded import library 
#       pragma comment(lib, "ocf-630-b2-ti.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
