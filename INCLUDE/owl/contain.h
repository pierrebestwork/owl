...
typedef TObjectArray<owl_string>                       TStringArray;
typedef TObjArrayIterator<owl_string,TStringArray>     TStringArrayIterator;
typedef TSortedObjectArray<owl_string>                 TSortedStringArray;
typedef TObjArrayIterator<owl_string, TSortedStringArray> TSortedStringArrayIterator;
