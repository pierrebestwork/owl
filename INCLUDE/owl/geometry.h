...
_OWLCFUNC(_tistream&)  operator >>(_tistream& is, TPoint& p);
_OWLCFUNC(opstream&) operator <<(opstream& os, const TPoint& p);
_OWLCFUNC(_tostream&)  operator <<(_tostream& os, const TPoint& p);
...
_OWLCFUNC(_tistream&)  operator >>(_tistream& is, TPointL& p);
_OWLCFUNC(opstream&) operator <<(opstream& os, const TPointL& p);
_OWLCFUNC(_tostream&)  operator <<(_tostream& os, const TPointL& p);
...
_OWLCFUNC(_tistream&) operator >>(_tistream& is, TPointF& p);
_OWLCFUNC(opstream&) operator <<(opstream& os, const TPointF& p);
_OWLCFUNC(_tostream&) operator <<(_tostream& os, const TPointF& p);
...
_OWLCFUNC(_tistream&)   operator >>(_tistream& os, TSize& s);
_OWLCFUNC(opstream&)   operator <<(opstream& os, const TSize& s);
_OWLCFUNC(_tostream&)   operator <<(_tostream& os, const TSize& s);
...
_OWLCFUNC(_tistream&)  operator >>(_tistream& is, TRect& r);
_OWLCFUNC(opstream&) operator <<(opstream& os, const TRect& r);
_OWLCFUNC(_tostream&)  operator <<(_tostream& os, const TRect& r);
...
TRect::Normalized() const
{
  return TRect(__min(left, right), __min(top, bottom),
               __max(left, right), __max(top, bottom));
}
...
{
  if (Touches(other))
    return TRect(__max(left, other.left), __max(top, other.top),
                 __min(right, other.right), __min(bottom, other.bottom));
...
TRect::operator |(const TRect& other) const
{
  return TRect(__min(left, other.left), __min(top, other.top),
               __max(right, other.right), __max(bottom, other.bottom));
}
