...
#endif
#if !defined(OWL_SHELLITM_H) && !defined(BI_SUPPRESS_OLE)
...
//!YB
//!YB DECLARE_STREAMABLE_FROM_BASE(_OWLCLASS, __OWL TPageScroller, 1);
};
...
inline TColor TPageScroller::GetBkColor() const{
  PRECONDITION(GetHandle());
   return TColor(CONST_CAST(TPageScroller*,this)->SendMessage(PGM_GETBKCOLOR,0,0));
}
