...
//                  { nmEnterPage, id, (TAnyDispatcher)NS_OWL::v_LPARAM_Dispatch,
...
#define DECLARE_SIGNATURE1(R,Name,P1) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1)))(P1) \
        { return pmf; }

#define DECLARE_SIGNATURE2(R,Name,P1,P2) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1,P2)))(P1,P2) \
        { return pmf; }

#define DECLARE_SIGNATURE3(R,Name,P1,P2,P3) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1,P2,P3)))(P1,P2,P3) \
        { return pmf; }

#define DECLARE_SIGNATURE4(R,Name,P1,P2,P3,P4) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1,P2,P3,P4)))(P1,P2,P3,P4) \
        { return pmf; }

#define DECLARE_SIGNATURE5(R,Name,P1,P2,P3,P4,P5) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1,P2,P3,P4,P5)))\
                                                      (P1,P2,P3,P4,P5) \
        { return pmf; }

#define DECLARE_SIGNATURE6(R,Name,P1,P2,P3,P4,P5,P6) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1,P2,P3,P4,P5,P6)))\
                                                      (P1,P2,P3,P4,P5,P6) \
        { return pmf; }

#define DECLARE_SIGNATURE7(R,Name,P1,P2,P3,P4,P5,P6,P8) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1,P2,P3,P4,P5,P6,P8)))\
                                                      (P1,P2,P3,P4,P5,P6,P8) \
        { return pmf; }

#define DECLARE_SIGNATURE9(R,Name,P1,P2,P3,P4,P5,P6,P8,P9) \
    template <class T> \
    inline R _CALLCNVN (T::*Name(R _CALLCNVN (T::*pmf)(P1,P2,P3,P4,P5,P6,P8,P9)))\
...
DECLARE_SIGNATURE3(bool,B_U_U_POINT_Sig,uint,uint,TPoint&)
DECLARE_SIGNATURE3(bool,B_U_i_POINT_Sig,uint,int,TPoint&)

DECLARE_SIGNATURE2(bool,B_B_HKL_Sig,bool,HKL)
DECLARE_SIGNATURE2(bool,B_I_HKL_Sig,int,HKL)
//DECLARE_SIGNATURE1(void,v_HELPINFO_Sig,HELPINFO&)   //Jogy - it's not used anywhere
...
DECLARE_SIGNATURE1(int32,I32_MDICREATESTRUCT_Sig,MDICREATESTRUCT &)
DECLARE_SIGNATURE2(int32,I32_U_COMPAREITEM_Sig,uint,COMPAREITEMSTRUCT &)
DECLARE_SIGNATURE2(int32,I32_U_I32_Sig,uint,int32)
DECLARE_SIGNATURE3(int32,I32_U_U_HMENU_Sig,uint,uint,HMENU)
...
DECLARE_SIGNATURE1(uint,U_MSG_Sig,MSG *)
DECLARE_SIGNATURE1(uint,U_POINT_Sig,TPoint&)
...
DECLARE_SIGNATURE1(void,v_HELPINFO_Sig,HELPINFO *)
DECLARE_SIGNATURE2(void,v_HWND_PCOPYDATASTRUCT_Sig,HWND,COPYDATASTRUCT*)
...
DECLARE_SIGNATURE2(void,v_OWLWINDOWDOCKED_Sig,uint,TDockingSlip*)
DECLARE_SIGNATURE1(void,v_OWLHELPHIT_Sig,const THelpHitInfo&)
DECLARE_SIGNATURE1(void,v_POINT_Sig,TPoint&)
...
DECLARE_SIGNATURE2(void,v_U_DELETEITEM_Sig,uint,DELETEITEMSTRUCT &)
DECLARE_SIGNATURE2(void,v_U_DRAWITEM_Sig,uint,DRAWITEMSTRUCT &)
DECLARE_SIGNATURE2(void,v_U_MEASUREITEM_Sig,uint,MEASUREITEMSTRUCT &)
DECLARE_SIGNATURE2(void,v_U_POINT_Sig,uint,TPoint&)
DECLARE_SIGNATURE2(void,v_U_S_Sig,uint,LPTSTR)
DECLARE_SIGNATURE2(void,v_U_SIZE_Sig,uint,TSize&)
