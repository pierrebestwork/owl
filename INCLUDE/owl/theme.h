...
//  TModuleProc6 <HRESULT, HTHEME, HDC, int, int, const RECT*, const DTBGOPTS*> DrawThemeBackgroundEx;
...
public:
  ...
  TXTheme(LPCTSTR name = 0, HRESULT = 0);
  ...
  static void Raise(LPCTSTR name = 0, HRESULT = 0);
};
