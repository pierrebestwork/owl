...
class _OWLCLASS TTooltip : public TControl {
  public:
   ...
   ~TTooltip();
    ...
    int          GetMaxTipWidth() const; // Version 4.70
...
{
  return CONST_CAST(TTooltip*, this)->SendMessage(TTM_GETDELAYTIME,flag);
}
...
// Version 4.70
inline int TTooltip::GetMaxTipWidth() const
{
...
{
  return TColor(CONST_CAST(TTooltip*, this)->SendMessage(TTM_GETTIPBKCOLOR));
}
...
{
  return TColor(CONST_CAST(TTooltip*, this)->SendMessage(TTM_GETTIPTEXTCOLOR));
}
