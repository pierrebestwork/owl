...
class _OWLCLASS TUIFace {
  public:
    ...
    TUIFace(const TRect& faceRect, LPCTSTR text,
    ...
    static void   PaintIcon(const TIcon& icon, const TRect& glyphSrcRect,
                          ...
                          TState state, bool pressed, bool fillFace,
                          const TColor& maskColor, const TColor& fillColor);
    static void   PaintText(LPCTSTR text, TDC& dc, const TRect& faceRect,
    ...
    static int    DrawTextEtched(TDC& dc, LPCTSTR str, int count,
...
//
inline
TUIFace::TUIFace(const TRect& faceRect, LPCTSTR text,
