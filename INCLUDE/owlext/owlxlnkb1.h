...
#       pragma comment(lib, "owlext-630-b1-dvc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug VCL multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dvc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug VCL multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dvc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug VCL multi-threaded import library 
#       pragma comment(lib, "owlext-630-b1-dvi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
...
#       pragma comment(lib, "owlext-630-b1-dvc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug VCL multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dvc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)
	      // Debug VCL multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dvc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug VCL multi-threaded static library 
#       pragma comment(lib, "owlext-630-b1-dv.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "owlext-630-b1-dtusc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded Unicows OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dtusc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded Unicows OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dtusc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded Unicows import library 
#       pragma comment(lib, "owlext-630-b1-dtusi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b1-dtuc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded Unicode OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dtuc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded Unicode OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dtuc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded Unicode import library 
#       pragma comment(lib, "owlext-630-b1-dtui.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicode end
#     else                        //#if defined(USE_UNICOWS)
       // Single-byte
...
#       pragma comment(lib, "owlext-630-b1-dtc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dtc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dtc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded import library 
#       pragma comment(lib, "owlext-630-b1-dti.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b1-dtusc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded Unicows OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dtusc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded Unicows OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dtusc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded Unicows static library 
#       pragma comment(lib, "owlext-630-b1-dtus.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b1-dtc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dtc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dtc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded static library 
#       pragma comment(lib, "owlext-630-b1-dt.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "owlext-630-b1-dsusc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
		  // Debug single-threaded Unicows OWL2 compatibility import library
#       pragma comment(lib, "owlext-630-b1-dsusc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded Unicows OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dsusc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded Unicows import library 
#       pragma comment(lib, "owlext-630-b1-dsusi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b1-dsuc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded Unicode OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dsuc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded Unicode OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dsuc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded Unicode import library 
#       pragma comment(lib, "owlext-630-b1-dsui.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicode end
#     else                        //#if defined(USE_UNICOWS)
       // Single-byte
...
#       pragma comment(lib, "owlext-630-b1-dsc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dsc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-dsc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded import library 
#       pragma comment(lib, "owlext-630-b1-dsi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b1-dsusc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded Unicows OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dsusc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded Unicows OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dsusc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded Unicows static library 
#       pragma comment(lib, "owlext-630-b1-dsus.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b1-dsc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dsc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-dsc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded static library 
#       pragma comment(lib, "owlext-630-b1-ds.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "owlext-630-b1-vc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release VCL multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-vc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release VCL multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-vc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release VCL multi-threaded import library 
#       pragma comment(lib, "owlext-630-b1-vi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b1-tc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-tc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-tc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release multi-threaded import library 
#       pragma comment(lib, "owlext-630-b1-ti.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b1-tc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-tc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-tc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release multi-threaded static library 
#       pragma comment(lib, "owlext-630-b1-t.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "owlext-630-b1-sc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release single-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-sc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release single-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b1-sc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release single-threaded import library 
#       pragma comment(lib, "owlext-630-b1-si.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b1-sc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release single-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-sc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release single-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b1-sc5.lib")
#      else                         //if defined(OWL1_COMPAT)
		  // Release single-threaded static library
#       pragma comment(lib, "owlext-630-b1-s.lib")
#      endif		                    //if defined(OWL1_COMPAT)
	   // Single-bye end
#     endif                       //#if defined(UNICODE)
	  // static library end
