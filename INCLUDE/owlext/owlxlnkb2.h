...
#if !defined(OWLEXT_OWLEXTLNKB2_H)
#define OWLEXT_OWLEXTLNKB2_H
...
#       pragma comment(lib, "owlext-630-b2-dvc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug VCL multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dvc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)
	      // Debug VCL multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dvc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug VCL multi-threaded static library 
#       pragma comment(lib, "owlext-630-b2-dv.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
#    endif	                    // #if defined(_OWLEXTDLL)	
...
#       pragma comment(lib, "owlext-630-b2-dtusc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded Unicows OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dtusc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded Unicows OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dtusc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded Unicows import library 
#       pragma comment(lib, "owlext-630-b2-dtusi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b2-dtuc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded Unicode OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dtuc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded Unicode OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dtuc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded Unicode import library 
#       pragma comment(lib, "owlext-630-b2-dtui.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicode end
#     else                        //#if defined(USE_UNICOWS)
       // Single-byte
...
#       pragma comment(lib, "owlext-630-b2-dtc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dtc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dtc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded import library 
#       pragma comment(lib, "owlext-630-b2-dti.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b2-dtusc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded Unicows OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dtusc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded Unicows OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dtusc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded Unicows static library 
#       pragma comment(lib, "owlext-630-b2-dtus.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b2-dtc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dtc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dtc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug multi-threaded static library 
#       pragma comment(lib, "owlext-630-b2-dt.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "owlext-630-b2-dsusc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
		  // Debug single-threaded Unicows OWL2 compatibility import library
#       pragma comment(lib, "owlext-630-b2-dsusc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded Unicows OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dsusc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded Unicows import library 
#       pragma comment(lib, "owlext-630-b2-dsusi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b2-dsuc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded Unicode OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dsuc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded Unicode OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dsuc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded Unicode import library 
#       pragma comment(lib, "owlext-630-b2-dsui.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicode end
#     else                        //#if defined(USE_UNICOWS)
       // Single-byte
...
#       pragma comment(lib, "owlext-630-b2-dsc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dsc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-dsc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded import library 
#       pragma comment(lib, "owlext-630-b2-dsi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b2-dsusc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded Unicows OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dsusc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded Unicows OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dsusc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded Unicows static library 
#       pragma comment(lib, "owlext-630-b2-dsus.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Unicows end
#     elif defined(UNICODE)   //#if defined(USE_UNICOWS)
       // Unicode
...
#       pragma comment(lib, "owlext-630-b2-dsc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Debug single-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dsc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Debug single-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-dsc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Debug single-threaded static library 
#       pragma comment(lib, "owlext-630-b2-ds.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "owlext-630-b2-vc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release VCL multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-vc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release VCL multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-vc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release VCL multi-threaded import library 
#       pragma comment(lib, "owlext-630-b2-vi.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b2-tc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release multi-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-tc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release multi-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-tc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release multi-threaded import library 
#       pragma comment(lib, "owlext-630-b2-ti.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b2-tc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release multi-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-tc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release multi-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-tc5.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release multi-threaded static library 
#       pragma comment(lib, "owlext-630-b2-t.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // static library end
...
#       pragma comment(lib, "owlext-630-b2-sc1i.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release single-threaded OWL2 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-sc2i.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release single-threaded OWL5 compatibility import library 
#       pragma comment(lib, "owlext-630-b2-sc5i.lib")
#      else                         //if defined(OWL1_COMPAT)
	      // Release single-threaded import library 
#       pragma comment(lib, "owlext-630-b2-si.lib")
#      endif		                    //if defined(OWL1_COMPAT)
       // Single-bye end
#     endif                       //#if defined(UNICODE)
      // DLL import library end
...
#       pragma comment(lib, "owlext-630-b2-sc1.lib")
#      elif defined(OWL2_COMPAT)   	//if defined(OWL1_COMPAT)		
	      // Release single-threaded OWL2 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-sc2.lib")
#      elif defined(OWL5_COMPAT)	 	//if defined(OWL1_COMPAT)	
	      // Release single-threaded OWL5 compatibility static library 
#       pragma comment(lib, "owlext-630-b2-sc5.lib")
#      else                         //if defined(OWL1_COMPAT)
		  // Release single-threaded static library
#       pragma comment(lib, "owlext-630-b2-s.lib")
#      endif		                    //if defined(OWL1_COMPAT)
	   // Single-bye end
#     endif                       //#if defined(UNICODE)
	  // static library end
