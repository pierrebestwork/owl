...
TAutoClass::TAutoClass(TAutoSymbol* table, TAutoSymbol* classSymbol,
             const __OWL_TYPEINFO& typeInfo, TAggregator aggregator)
...
__OCF_END_NAMESPACE
//
// Temporary defines for using __OWL_TYPEINFO with dynamic cast
//
...
//
const void*
DynamicCast(const void* obj, const __OWL_TYPEINFO& src, const __OWL_TYPEINFO& dst)
{
#if defined(BI_COMP_BORLANDC)
  int vtblOff;
  if (!obj)
...
//
const void *
MostDerived(const void * obj, const __OWL_TYPEINFO& src)
{
#if defined(BI_COMP_BORLANDC)
  int vtblOff;
