...
CL_OPT=/D_OCFPCH /D_OWLPCH
CPPFLAGS=/D_OCFPCH /D_OWLPCH
...
$(PCH_TARGETS):: msc\$(PCH_CPP).cpp $(HDRS)
	$(MSCL) @<<
/Yc /Fp$(PCH_FILE) $(CL_MODEL) $(CL_OPT) $(DLL_OPT) $(PDBOPTS) $(DEFS) $(OPT) /D_OWLPCH /D_OCFPCH /c msc\$(PCH_CPP).cpp
<<
!if "$(BROWSE)" != "0"
...
CPPFLAGS_STATIC=\
	$(CL_MODEL) $(CL_OPT) $(DEFS) $(DEBDEF) /I$(OWLROOT)\include /D_OCFDLL /D_OCFPCH /D_OWLDLL /D_OWLPCH $(OPT) $(EH) /Gy /Fd$(LIBDIR)\$(GOAL)i.pdb
...
PCH_TARGET=$D\ocfpchs.obj

$D\ocfpchs.obj $D\ocfpchs.pch: msc\ocfpchs.cpp 
	$(MSCL) @<<
/c $(CPPFLAGS_STATIC) /Yc /Fp$D\ocfpchs.pch msc\ocfpchs.cpp
<<

#-------------------------------------------------
# Build target

$D\$(LIBNAME).res: ocfall.rc
	$(MSRC) $(RCFLAGS) $(RCDEFINES) /i$(OWLROOT)\include;$(OWLROOT)\include\owl;$(OWLROOT)\include\ocf /fo $D\$(LIBNAME).res ocfall.rc
