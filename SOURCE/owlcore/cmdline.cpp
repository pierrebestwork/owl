...
const _TCHAR whitespace[] = _T(" \t");
const _TCHAR terminator[] = _T("=/ \t\"");  // remove /- to dissallow separating there

TCmdLine::TCmdLine(const _TCHAR * cmdLine)
{
