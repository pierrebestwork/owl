...
:
  ...
  FixedInfo(0)
{
  TTmpBuffer<_TCHAR> modFName(_MAX_PATH);
...
//
TModuleVersionInfo::TModuleVersionInfo(owl_string modFName)
:
  Buff(0),
  Lang(0),
  FixedInfo(0)
...
//
// Retrieve the file description information in the requested language id.
//
...
//
owl_string TModuleVersionInfo::GetInfoString(owl_string str, uint lang)
...
//
owl_string TModuleVersionInfo::GetFileDescription(uint lang)
...
// String version. [VH 2005-04-03]
//
owl_string TModuleVersionInfo::GetFileVersion(uint lang)
...
// String version. [VH 2005-04-03]
//
owl_string TModuleVersionInfo::GetInternalName(uint lang)
...
// String version. [VH 2005-04-03]
//
owl_string TModuleVersionInfo::GetLegalCopyright(uint lang)
...
// String version. [VH 2005-04-03]
//
owl_string TModuleVersionInfo::GetOriginalFilename(uint lang)
...
// String version. [VH 2005-04-03]
//
owl_string TModuleVersionInfo::GetProductName(uint lang)
...
// String version. [VH 2005-04-03]
//
owl_string TModuleVersionInfo::GetProductVersion(uint lang)
...
// String version. [VH 2005-04-03]
//
owl_string TModuleVersionInfo::GetSpecialBuild(uint lang)
...
TModuleVersionInfo::GetLanguageName(uint lang)
{
  ...
  return owl_string((TCHAR*)langStr);
}
...
//
TXModuleVersionInfo::TXModuleVersionInfo(LPCTSTR name)
:
...
//
void
TXModuleVersionInfo::Raise(LPCTSTR name)
{
