...
//
//
TTrayIcon::TTrayIcon(TWindow* parent, uint msg, const owl_string& tip, TIcon& icon,
...
//
TTrayIcon::TTrayIcon(TWindow* parent, uint msg, const owl_string& tip, 
...
//
//
void TTrayIcon::Init(TWindow* parent, uint msg, const owl_string& tip, 
                     TIcon* icon, uint id)
{
...
//
//
owl_string TTrayIcon::GetText() const
{
  return owl_string(szTip);
}
...
//
bool TTrayIcon::SetText(const owl_string& text)
{
