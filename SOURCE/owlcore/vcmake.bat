...
rem echo ---
rem echo --- Building the OWLNext Release DLL
rem echo ---
rem %MAKE% DLL=1 %COMMON% 
rem echo.

rem echo ---
rem echo --- Building the OWLNext Debug DLL
rem echo ---
...
rem echo ---
rem echo --- Building the OWLNext Unicode Release DLL
rem echo ---
rem %MAKE% UNICODE=1 DLL=1 %COMMON% 
rem echo.

rem echo ---
rem echo --- Building the OWLNext Unicode Debug DLL
rem echo ---
rem %MAKE% UNICODE=1 DLL=1 %DEBUGS% %COMMON% 
rem echo.

rem echo ---
rem echo --- Building the OWLNext Unicode Static Release Library
rem echo ---
rem %MAKE% UNICODE=1 %COMMON%
rem echo.

rem echo ---
rem echo --- Building the OWLNext Unicode Static Debug Library
rem echo ---
