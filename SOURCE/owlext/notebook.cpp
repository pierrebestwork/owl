...
int TNotebook::DrawHorzTab(TDC& mydc, int tabnum, int rgnnum, int toff)
{
	...
	GetTextExtentPoint(mydc, tabname, _tcslen(tabname),&textsize);
...
int TNotebook::DrawVertTab(TDC &mydc, int tabnum, int rgnnum, int toff)
{
	...
	mydc.TextOut(xval, yval, tabname, _tcslen(tabname));
...
//----------------------------------------------------------------------------
void
TNotebook::EvNCLButtonDown(uint hitTest, TPoint& screenPt)
{
...
//----------------------------------------------------------------------------
void
TNotebook::EvNCLButtonDblClk(uint hitTest, TPoint& screenPt)
{
	if (MyLButtonDown(hitTest, screenPt))
		return;
...
//----------------------------------------------------------------------------
void
TNotebook::EvMouseMove(uint hitTest, TPoint& clientpt)
{
...
//----------------------------------------------------------------------------
void
TNotebook::EvLButtonUp(uint hitTest, TPoint& clientpt)
{
	// convert from client to windows coords
	TPoint screenpt = clientpt;
	ClientToScreen(screenpt);
...
//----------------------------------------------------------------------------
void
TNotebook::EvSize(uint sizeType, TSize& newsize)
{
